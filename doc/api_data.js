define({ "api": [
  ...
  },
  {
    ...
    "title": "",
    "name": "status_change_for_display_banner",
    "description": "<p>Used to status change for display banner</p>",
    "group": "Admin___Coupon",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "title": "ploting graph",
    "name": "Graph",
    "description": "<p>To display graph</p>",
  ...
  {
    "type": "post",
    "url": "/admin/reports/add/category",
    "title": "Add category",
    "name": "Add_New_Category",
    "description": "<p>Used to add category</p>",
    "group": "Admin___Feedback",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "category_name",
            "description": "<p>Add category_name</p>"
          }
        ]
      }
    },
    ...
    "version": "0.0.0",
    "filename": "controllers/admin/car_report.js",
    "groupTitle": "Admin___Feedback"
  },
  {
    "type": "post",
    "url": "/admin/reports/category_list",
    "title": "List of all superadmin category",
    "name": "Category_List",
    "description": "<p>To display category list with pagination</p>",
    "group": "Admin___Feedback",
    "version": "0.0.0",
    "parameter": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/admin/reports/change_status",
    "title": "change status for report",
    "name": "Change_report_status",
    "description": "<p>This is for change report status</p>",
    "group": "Admin___Feedback",
    "version": "0.0.0",
    "parameter": {
      "fields": {
  ...
  {
    "type": "put",
    "url": "/admin/reports/delete/category",
    "title": "Delete category",
    "name": "Delete_Category",
    "description": "<p>Used to Delete category</p>",
    "group": "Admin___Feedback",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "title": "create reported car list",
    "name": "Listing_of_reported",
    "description": "<p>This is for listing reported car</p>",
    "group": "Admin___Feedback",
    "version": "0.0.0",
    "parameter": {
      "fields": {
  ...
  },
  {
    ...
    "name": "Report_Detail",
    "description": "<p>This is for get report details</p>",
    "group": "Admin___Feedback",
    "version": "0.0.0",
    "parameter": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/admin/reports/update/category",
    "title": "Update category",
    "name": "Update_Category",
    "description": "<p>Used to update category</p>",
    "group": "Admin___Feedback",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/app/car/report-category-list",
    "title": "Car report category list",
    "name": "Car_report_category_list",
    "description": "<p>Used to get car report category list</p>",
    "group": "App___Car",
    "version": "0.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/app/car/check-delivery-radius-v2",
    "title": "Check car delivery radius",
    "name": "Check_car_delivery_radius",
    "description": "<p>Check car will be deliver or not on given location by user when book particular car</p>",
    "group": "App___Car",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "city",
            "description": "<p>city name (full name)</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/app/car/extend-booking",
    "title": "Extend Car Booking",
    "name": "Extend_Car_Booking",
    "description": "<p>Extend Car Booking</p>",
    "group": "App___Car",
    "parameter": {
      "fields": {
        "Parameter": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "report_type",
            "description": "<p>(car report category id)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "description": "<p>Used to get coupon list</p>",
    "group": "App___Coupon",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "car_rental_company_id",
            "description": "<p>id of car company</p>"
          }
        ]
      }
    },
